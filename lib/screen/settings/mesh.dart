...
class MeshConfigurationPage extends StatefulWidget {
  final DeviceConnection deviceConnection;
    final bool isEditable;

  const MeshConfigurationPage({super.key, required this.deviceConnection, required this.isEditable});

  @override
  State<MeshConfigurationPage> createState() => _MeshConfigurationPageState();
}

class _MeshConfigurationPageState extends State<MeshConfigurationPage> {
